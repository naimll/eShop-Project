...
<body>
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input required id="inputButtons" value="<?php echo $currentProduct['product_performance'] ?>" type="text" name="product_short_description" style="position:relative;left:5px;">
        </div>
        <div class="form-group">
